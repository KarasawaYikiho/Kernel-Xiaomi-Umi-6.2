...
def main() -> int:
    ...
    expect_equal(
        "common_primary_is_not_phase2_required",
        to_dtb_name("arch/arm64/boot/dts/qcom/xiaomi-sm8250-common.dts"),
        None,
    )
    expect_equal(
        "umi_primary_is_phase2_required",
        to_dtb_name("arch/arm64/boot/dts/qcom/sm8250-xiaomi-umi.dts"),
