...
def main() -> int:
    ...
    md = [
        ...
        f"- runtime_validation_status: `{report.get('runtime_validation_status', 'missing_input')}`",
        f"- runtime_validation_boot_method: `{report.get('runtime_validation_boot_method', 'unknown')}`",
