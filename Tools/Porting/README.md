...
- **Automation metrics:** `Collect_Metrics_Json.py`, `Check_Artifact_Completeness.py`, `Suggest_Next_Focus.py` (reuses shared decision mapping from `Phase2_Decision.py`), `Verify_Decision_Consistency.py`, `Extract_Build_Errors.py`
